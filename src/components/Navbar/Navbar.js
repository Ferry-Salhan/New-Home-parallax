...
<nav>
  <div className="navbar">
    ...
    <ul className="right hide-on-med-and-down">
      ...
      <i style={{
            'fontSize': 15
          }} class="fas fa-bars" /> Home</a></li>
      <li><a href="badges.html">About Us</a></li>
    
      {/* <!-- Dropdown Trigger --> */}
      <li><a className="dropdown-trigger" href="#!" data-target="dropdown1">Services
  ...
  // <li>
  //        <a class="active" href="#home"><i style={{
  //          'fontSize': 15
  //        }} class="fas fa-bars" /> Home</a>
  //        </li>
