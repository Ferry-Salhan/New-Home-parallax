          ...
          {/* <h4 className="center">
            ...
            <div className="col s12 l4">
              <div className="card-panel">
                ...
                <p className="text">Our team of designers build <strong style={{fontWeight: 'bold'}}>UNIQUE &amp; TAILOR MADE</strong> innovative web designs, which are more specific to your business needs.</p>
              </div>
            </div>
            <div className="col s12 l4">
              <div className="card-panel">
